        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div style="background-color: #E0E0E0; padding: 5px; border-radius: 3px;">
                    ...
                    <div class="text-center" style="margin:20px; padding: 10px 0 10px 0; background-color:#CEFCA3; border-radius: 3px;"><div class="label">HOST IP</div><div id="hostip" style="font-size: 150%; font-weight: bolder;"><?php echo($D['hostip']); ?></div></div>
                    <div class="text-center" style="margin:20px; padding: 10px 0 10px 0; background-color:#CEFCA3; border-radius: 3px;"><div class="label">YOUR IP</div><div id="hostip" style="font-size: 150%; font-weight: bolder;"><?php echo($D['yourip']); ?></div></div>
